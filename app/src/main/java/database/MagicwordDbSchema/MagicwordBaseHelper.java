...
import com.magicwords.fragments.ListenFragments;
...
public class MagicwordBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE Magicworddb(wordid INTEGER PRIMARY KEY AUTOINCREMENT," +
                "word VARCHAR(20)," +
                "yinbiao VARCHAR(255)," +
                "mean VARCHAR(255)," +
                "example VARCHAR(255))");
        db.execSQL(
                "INSERT INTO word(wordid,word,yinbiao,mean,example) values(?,?,?,?,?)",new Object[] { 1,
                        "A",
                        "[ə]",
                        "一,一个,一只,一件.",
        ...
        db.execSQL(
                "INSERT INTO word(wordid,word,yinbiao,mean,example) values(?,?,?,?,?)",new Object[] { 2,
                        "abdominal",
                        "[æb'dɑːmɪnl]",
                        "a. 腹部的",
                        " I'll have an abdominal operation tomorrow./r/n     我明天要做个腹部手术。/r/n\n She had abdominal pains yesterday./r/n     她昨天腹痛。/r/n"});
        db.execSQL(
                "INSERT INTO word(wordid,word,yinbiao,mean,example) values(?,?,?,?,?)",new Object[] { 3,
        ...
        db.execSQL(
                "INSERT INTO word(wordid,word,yinbiao,mean,example) values(?,?,?,?,?)",new Object[] { 4,
                        "bored", "[bɔːrd]", "a. 厌烦的,无聊的", " He is a bored student./r/n     他是一位感到厌烦的学生。/r/n\n The condition of being bored; ennui./r/n     厌烦处于厌烦的状态；无聊/r/n"});

        db.execSQL(
                "INSERT INTO word(wordid,word,yinbiao,mean,example) values(?,?,?,?,?)",new Object[] { 5,
        ...
        db.execSQL(
                "INSERT INTO word(wordid,word,yinbiao,mean,example) values(?,?,?,?,?)",new Object[] { 6,
